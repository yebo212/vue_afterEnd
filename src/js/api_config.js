...
export default {
    ...
    islogin: `/admin/account/islogin`, //是否登录状态
    ...
    atList: `/admin/article/getlist/`, //获取文章列表，需要参数：tablename,需要查询：pageIndex与pageSiize
    atCate: `/admin/article/getcategorylist/`, //获取文章的分类列表，需要参数：tablename
    atDetail: `/admin/article/getarticle/`, //获取文章详情,需要参数：tablename和atID
    atEdit: `/admin/article/edit/`, //编辑文章,需要参数：tablename和atID
    atAdd: `/admin/category/add/`, //添加文章，需要参数：tablename
    atDel: `/admin/category/del/`, //删除文章，需要参数：tablename和atID

    atImg: `/admin/article/uploadimg`, //上传文章图片
    atFile: `/admin/article/uploadfile`, //上传文章附件

    gsList: `/admin/goods/getlist/`, //获取商品列表，需要查询：pageIndex、pageSize和searchvalue
    gsDetail: `/admin/goods/getgoodsmodel/`, //获取商品详情，需要参数gsID
    gsEdit: `/admin/goods/edit/`, //编辑商品，需要参数：gsID
    gsAdd: `/admin/goods/add/`, //添加商品
    gsDel: `/admin/goods/del/`, //删除商品，需要参数：gsID

    odList: `/admin/order/getorderlist/`, //获取订单列表，需要查询：pageIndex、pageSize、orderstatus和vipname
    odDetail: `/admin/order/getorderdetail/`, //获取订单详情，需要参数：odID
